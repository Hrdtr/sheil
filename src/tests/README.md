...
Automated regression and smoke tests for this project.

## Purpose

This test harness serves two complementary goals:

1. **Dependency shield** — Detect breakages when updating Svelte, Tailwind, Lucide, TypeScript, Tauri, or any other dependency. Run `nub run test` after any update and get an immediate pass/fail verdict.
